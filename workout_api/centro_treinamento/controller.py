...
@router.get('/', summary='Consultar todaos os centros de treinamentos', status_code=status.HTTP_200_OK, response_model=list[CentroTreinamentoOut]  )
...
async def query(id: UUID4, db_session: DatabaseDependency ) -> CentroTreinamentoOut:    
    ...
    if not ct:
        HTTPException(stattus_code= status.HTTP_404_NOT_FOUND, details= 'categoria nâo encontrada no id:{id}')
